...
public class PermissionHelper {
    ...
    public static void requestPermissions(CordovaPlugin plugin, int requestCode, String[] permissions) {
        try {
            ...
            Toast.makeText(plugin.webView.getContext(), noSuchMethodException.toString(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(plugin.webView.getContext(), illegalAccessException.toString(), Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(plugin.webView.getContext(), invocationTargetException.toString(), Toast.LENGTH_SHORT).show();
